...
export const ubuntuManualText = `# Manual de Instalação Completo do Sistema de Rastreamento Veicular no Ubuntu 22.04
...
export const dockerManualText = `# Manual de Instalação do Sistema de Rastreamento Veicular com Docker
